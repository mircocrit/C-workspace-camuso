...
Data::Data() : Data(0,0,0) {} //forziamo nel delegato la data default = data oggi
...
tm* Data::oggi = Data::data_corrente();	//rileviamo in automatico la data corrispondente a oggi NB: questo codice sara' eseguito PRIMA del main
