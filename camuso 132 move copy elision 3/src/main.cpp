...
Immagine_full_HD test_NRVO() //named return value optimization
{
    Immagine_full_HD x{};
    return x;
}

Immagine_full_HD test_RVO() //return value optimization
{
    return Immagine_full_HD{};
}
 //copy elision
...
int main()
{
 ...
 //cout << "--------------------------------------------------------------\n";
 //di questo metodo discuteremo nella terza parte ...
 Immagine_full_HD img = test_NRVO();
