...
bool Data::operator<(const Data& altra){
  ...
  return false;  //13-06-2017   14-02-2017  s1 == "20170613"  s2 == "20170214"
}
...
std::string Data::formato_breve() const{  return std::to_string(giorno) + "/" + std::to_string(mese) + "/" +  std::to_string(anno);}
